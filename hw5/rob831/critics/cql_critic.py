...
class CQLCritic(BaseCritic):
    ...
    def dqn_loss(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        """ Implement DQN Loss """
        #TODO: Implement standard double-DQN loss
    ...
    def update(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        ...
        #q_t_logsumexp = #TODO 
        ## miao: 
        q_t_logsumexp = qa_t_values.logsumexp(dim=1) #( ( (qa_t_values).exp() ).sum(dim=1) ).log()
        #cql_loss = #TODO
        ## miao
        ...
        #print(dqn_loss.item(), cql_loss.item())
