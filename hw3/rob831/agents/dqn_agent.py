...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        ## miao 
        self.replay_buffer_idx = self.replay_buffer.store_frame(frame=self.last_obs)
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        log = {}
        ## miao
        #print('t={} learning_starts={} can_sample={}'.format(
        #    self.t, self.learning_starts, self.replay_buffer.can_sample(self.batch_size)))
        ...
        if (self.t > self.learning_starts
            ...
            #TODO
            ## miao
            #print(ac_na) # ac_na 1827959728 triggered error
            #print('ac na shape = {}'.format(ac_na.shape))
            log = self.critic.update(ob_no=ob_no, 
                ac_na=ac_na, 
