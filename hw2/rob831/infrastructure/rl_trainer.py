...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        # miao save data to plot learning curves
        train_rewards_np = np.array(self.train_rewards)
        eval_rewards_np = np.array(self.eval_rewards)
        np.savetxt('./learning_rewards/'+self.params['exp_name']+'_train.txt', train_rewards_np)
        np.savetxt('./learning_rewards/'+self.params['exp_name']+'_eval.txt', eval_rewards_np)
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, all_logs):
        ...
        if self.logmetrics:
            ...
            # miao
            self.train_rewards.append([logs["Train_AverageReturn"], logs["Train_StdReturn"]])
            self.eval_rewards.append([logs["Eval_AverageReturn"], logs["Eval_StdReturn"]])
